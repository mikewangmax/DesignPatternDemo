...
import com.mike.designpattern.observer1.DisplayElement;

public class ConditionDisplay1 implements Observer, DisplayElement{
	private float mTemprature;
	private float mHumidity;
	private float mPressure;
	private Observable mObservable;
	
	public ConditionDisplay1 (Observable o) {
		mObservable = o;
